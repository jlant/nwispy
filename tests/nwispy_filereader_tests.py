...
def test_data_instantaneous_multi_parameter():
    ...
    expected = {
        ...
        "parameters": [
            ...
            "index": 4,
            "data": stage_data,
            "mean": np.nanmean(stage_data),
            "max": np.nanmax(stage_data),
            "min": np.nanmin(stage_data),
            },
            {
            "code": "03_00010",
            ...
            "mean": np.nanmean(temperature_data),
            "max": np.nanmax(temperature_data),
            "min": np.nanmin(temperature_data),
            },
            {
            "code": "04_00300",
            ...
            "mean": np.nanmean(dissolved_oxygen_data),
            "max": np.nanmax(dissolved_oxygen_data),
            "min": np.nanmin(dissolved_oxygen_data),
            },
            {
            "code": "05_00400",
            ...
            "index": 8,
            "data": ph_data,
            "mean": np.nanmean(ph_data),
            "max": np.nanmax(ph_data),
            "min": np.nanmin(ph_data),
            },
            {
            "code": "06_00095",
            ...
            "mean": np.nanmean(conductance_data),
            "max": np.nanmax(conductance_data),
            "min": np.nanmin(conductance_data),
            },
            {
            "code": "07_63680",
            ...
            "index": 12,
            "data": turbidity_data,
            "mean": np.nanmean(turbidity_data),
            "max": np.nanmax(turbidity_data),
            "min": np.nanmin(turbidity_data),
            },            
        ],
        "dates": dates,    
        "timestep": "instantaneous"   
